...
const themes = {
    dark: {
        ...
        bgItemList: getColor('primary-500 opacity-50'),
        bgItemListActive: getColor('secondary-500 opacity-50'),
        textItemList: getColor('text-500'),
        textPlaying: getColor('text-500'),
        overlayPlaying: getColor('primary-500 opacity-50'),
        overlayCaratula: getColor('darkShades-500 opacity-50'),
        titlePlayer: getColor('text-500'),
        artistPlayer: getColor('text-700'),
        numPlayer: getColor('text-500'),
        bgBarPlayer: getColor('text-500'),
    ...
    light: {
        ...
        textPlaying: getColor('text-500'),
        overlayPlaying: getColor('primary-500 opacity-50'),
        overlayCaratula: getColor('lightShades-500 opacity-50'),
        titlePlayer: getColor('darkShades-700'),
        artistPlayer: getColor('darkShades-500'),
        numPlayer: getColor('darkShades-500'),
        bgBarPlayer: getColor('darkShades-200'),
